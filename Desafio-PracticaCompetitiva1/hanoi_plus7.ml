...
let hanoi n (a1, b1, c1) (a2, b2, c2) =
  ...
  then raise (Invalid_argument "Estados no estables") 
    ...
    let rec aux1 secuencias2 visitados2 rev_secuencias2 rev_visitados2=
        ...
        let sec_filtered=filtrar_por_puntaje_final estado_inicial sec_filtered in
        let rev_sec_filtered=filtrar_por_puntaje_final estado_final rev_sec_filtered in
